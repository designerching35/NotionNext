...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'hexo', // 主题， 支持 ['next','hexo',"fukasawa','medium','example'] @see https://advdesigner.vercel.app
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '用简单好玩的方式  建立第二收入',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '涵升老师', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个内向的营销人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://advdesigner.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 测试', // 网站关键词 英文逗号隔开
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'facebook,telegram,whatsapp,wechat', // 分享的服務，按顺序显示,逗号隔开
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-L3CPNL047M', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  SEO_GOOGLE_SITE_VERIFICATION:
      process.env.NEXT_PUBLIC_SEO_GOOGLE_SITE_VERIFICATION || 'Lm6JAVvxNhOQD48DSBxRNNB6Bl1NEGfoh6hFV5ndLWk', // Remove the value or replace it with your own google site verification code
